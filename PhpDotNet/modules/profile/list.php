...
?>
    <div class="options" ">
        ...
        <div class="button">
            ...
            <li>
                <a href="<?php echo PHPDOTNETROOTLIVE."modules/controller.php"?>?op=module&view=edit&module=profile&lang=<?php echo $_SESSION['languages']->GetLang();?>" class="action"><i class="icon-plus-sign"></i><?php echo $_SESSION['languages']->GetString('ADD');?></a>
            </li>
            <?php// endif; ?>

            <?php ///if($_SESSION['usuario']->hasCredential('_zonasgeograficas', 'edit')):?>
            <li>
                <a href="<?php echo PHPDOTNETROOTLIVE."modules/controller.php"?>?op=module&view=edit&module=profile&lang=<?php echo $_SESSION['languages']->GetLang();?>" class="edit"><i class="icon-pencil"></i><?php echo $_SESSION['languages']->GetString('EDIT');?></a>
            </li>
            <?php// endif; ?>

            <?php //if($_SESSION['usuario']->hasCredential('_zonasgeograficas', 'delete')):?>
            <li>
                <a href="<?php echo PHPDOTNETROOTLIVE.'';?>DSDatosHelper.php?op=controller&table=t_rol&task=delete&lang=<?php echo $_SESSION['languages']->GetLang();?>" class="delete">
...
<form id="frmguardar" name="frmguardar" onSubmit="return AjaxUpdate('<?php echo PHPDOTNETROOTLIVE;?>modules/controller.php?op=module&view=list-tabla&module=profile&lang=<?php echo $_REQUEST["lang"];?>', 'updatelisttab5', 'frmguardar','<?php echo PHPDOTNETROOTLIVE;?>',errors)">

        <div class="searchbox">
            <label for="nombre" class="in_block w9p"><?php echo $_SESSION['languages']->GetString('PROFILE');?>:</label>
